...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-gentle",
        destructive:
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-gentle text-base font-semibold",
        warm: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-warm",
        soft: "bg-primary-soft text-primary hover:bg-primary/20",

        // Novos: cores de marca
        mercadolivre: "bg-[#ffe600] text-black hover:bg-[#ffea33]",
        amazon: "bg-[#232f3e] text-white hover:bg-[#37475a]",
      },
      size: {
